#ifndef NEAREST_NEIGHBOR_TSP_H
#define NEAREST_NEIGHBOR_TSP_H
...
#include <building_navigation/contains.h>
#include <building_navigation/a_star_pathplanner.h>
#include <building_navigation/distance_matrix.h>
